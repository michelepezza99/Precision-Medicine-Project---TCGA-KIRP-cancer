...
We construct the Patient Similarity Network using normalized and log-transformed tumor expression data restricted to the DEGs. Raw counts are not used, as highly expressed genes would dominate similarity estimates.
...
### 4(opt). PSN and Community detection using Normal Gene Expression
...
## 5(opt). PSN communities characterization
